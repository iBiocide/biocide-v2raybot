...
if ($from_id == $admin || $userInfo['isAdmin'] == true) {
    $mainKeys = array();
    $temp = array();
    $mainKeys[] = [['text'=>'🛒  خرید کانفیگ جدید','callback_data'=>"buySubscription"]];
    $mainKeys[] = [['text'=>"🧑‍💼 حساب من",'callback_data'=>"myInfo"]];
    $mainKeys[] = [['text'=>"🎁 دریافت اکانت تست ",'callback_data'=>"getTestAccount"],['text'=>'📦  کانفیگ های من','callback_data'=>'mySubscriptions']];
    ...
    $mainKeys[] = [['text'=>'🔗 لینک نرم افزار ها','callback_data'=>"reciveApplications"]];
